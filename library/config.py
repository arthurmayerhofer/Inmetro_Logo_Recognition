...
ORIG_BASE_PATH = r'C:\Users\55279\Desktop\r_cnn\logos'
...
BASE_PATH = r'C:\Users\55279\Desktop\r_cnn\dataset'
POSITVE_PATH = os.path.sep.join([BASE_PATH, 'logo'])
NEGATIVE_PATH = os.path.sep.join([BASE_PATH, 'nao_logo'])
...
MODEL_PATH = "all_xception_model"
ENCODER_PATH = "all_xception_label_encoder.pkl"
